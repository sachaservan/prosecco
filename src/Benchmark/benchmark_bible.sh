...
dotnet run -c Release -- -p 50006 -f ~/data/sequence/seq-bible-lg.txt -s 0.40 -z 40000 -e 0.05 -a PrefixSpan -r 5 -d 5455350 -i n_ps-seq-bible-lg-0.40-40k
...
dotnet run -c Release -- -p 50006 -f ~/data/sequence/seq-bible-lg.txt -s 0.50 -z 40000 -e 0.05 -a PrefixSpan -r 5 -d 5455350 -i n_ps-seq-bible-lg-0.50-40k
...
dotnet run -c Release -- -p 50006 -f ~/data/sequence/seq-bible-lg.txt -s 0.60 -z 40000 -e 0.05 -a PrefixSpan -r 5 -d 5455350 -i n_ps-seq-bible-lg-0.60-40k
...
dotnet run -c Release -- -p 50006 -f ~/data/sequence/seq-bible-lg.txt -s 0.40 -z 60000 -e 0.05 -a PrefixSpan -r 5 -d 5455350 -i n_ps-seq-bible-lg-0.40-60k
...
dotnet run -c Release -- -p 50006 -f ~/data/sequence/seq-bible-lg.txt -s 0.50 -z 60000 -e 0.05 -a PrefixSpan -r 5 -d 5455350 -i n_ps-seq-bible-lg-0.50-60k
...
dotnet run -c Release -- -p 50006 -f ~/data/sequence/seq-bible-lg.txt -s 0.60 -z 60000 -e 0.05 -a PrefixSpan -r 5 -d 5455350 -i n_ps-seq-bible-lg-0.60-60k
