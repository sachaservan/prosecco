...
#loadRawData(d, 'ips_bms1_spmf_200_0.05.json', 'ProSecCo', 'BMS1_200')

loadRawData(d, '../ps-seq-bms-lg-0.01.json', 'PrefixSpan', 'KOSARAK')
loadRawData(d, '../ips-seq-bms-lg-0.01.json', 'ProSecCo', 'KOSARAK')

df = pd.DataFrame(data=d)   
print(df)

sns.boxplot(x="Dataset", y="Runtime", hue="Algorithm", data=df, palette={"PrefixSpan": flatui[0], "ProSecCo": flatui[1]})
