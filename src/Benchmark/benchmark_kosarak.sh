...
dotnet run -c Release -- -p 50003 -f ~/data/sequence/seq-kosarak-lg.txt -s 0.05 -z 10000 -e 0.05 -a ProSecCo -r 5 -d 1249951 -i n_ips-seq-kosarak-lg-0.05-10k
dotnet run -c Release -- -p 50003 -f ~/data/sequence/seq-kosarak-lg.txt -s 0.10 -z 10000 -e 0.05 -a ProSecCo -r 5 -d 1249951 -i n_ips-seq-kosarak-lg-0.10-10k
dotnet run -c Release -- -p 50003 -f ~/data/sequence/seq-kosarak-lg.txt -s 0.15 -z 10000 -e 0.05 -a ProSecCo -r 5 -d 1249951 -i n_ips-seq-kosarak-lg-0.15-10k
...
dotnet run -c Release -- -p 50003 -f ~/data/sequence/seq-kosarak-lg.txt -s 0.05 -z 80000 -e 0.05 -a ProSecCo -r 5 -d 1249951 -i n_ips-seq-kosarak-lg-0.05-80k
dotnet run -c Release -- -p 50003 -f ~/data/sequence/seq-kosarak-lg.txt -s 0.10 -z 80000 -e 0.05 -a ProSecCo -r 5 -d 1249951 -i n_ips-seq-kosarak-lg-0.10-80k
dotnet run -c Release -- -p 50003 -f ~/data/sequence/seq-kosarak-lg.txt -s 0.15 -z 80000 -e 0.05 -a ProSecCo -r 5 -d 1249951 -i n_ips-seq-kosarak-lg-0.15-80k